...
class MovieSeeder extends Seeder{
    ...
    $movies = [
        ...
        'movie_url' => 'The_Avengers_(2012_film)_poster.jpg', // image file name
      ...
      [
        ...
        'movie_url' => 'ShawshankRedemptionMoviePoster.jpg', // image file name
     ...
     [
        ...
        'movie_url' => 'lionking.jpg', // image file name
      ...
      [
        ...
        'movie_url' => 'The_Super_Mario_Bros._Movie_poster.jpg', // image file name
      ...
      [
        ...
        'movie_url' => 'Spirited_Away.jpg', // image file name
        ...
        'movie_url' => 'everything_at_once.jpg', // image file name
        ...
        'movie_url' => 'lala.jpg', // image file name
        ...
        'movie_url' => 'social.jpg', // image file name
        ...
        'movie_url' => 'matrix.jpg', // image file name
        ...
        'movie_url' => 'the burbs.jpg', // image file name
    ...
    foreach ($movies as $movieData)
    {
      ...
      //Not randomised as i want the actors to in order with their desinganated movie
      $actorIds = $movieData['actor_ids'];
      unset($movieData['actor_ids']);

      //Attaches the actors to their movies 
      //attach() inserts a row in the pivot table
      //MUST HAVE THE RELATIONSHIPS WORKING
